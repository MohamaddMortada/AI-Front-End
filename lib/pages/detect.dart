...
class _DetectState extends State<Detect> {
  ...
  Future<String?> _getOpenAITips(
    ...
    const String openAIKey =
        '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';
                      ...
                      children: [
                        ...
                        if (_media != null)
                          Container(
                            ...
                            height: isSmallScreen ? screenHeight * 0.25 : 200,
                            decoration: BoxDecoration(
                              color: Theme.of(context).primaryColor,
                          ...
                          const Column(
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  color: Color.fromARGB(255, 88, 6, 0),
                                  fontSize: 16,
                                ),
                                textAlign: TextAlign.center,
                              ),
